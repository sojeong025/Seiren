...
function PurchasePage() {
  ...
  useEffect(() => {
    customAxios.get("purposes").then(res => {
  ...
  return (
    <div className={styles.total}>
      <div className={styles.mainTxt}>결제하기</div>
      <div className={styles.container}>
            ...
            <div className={styles.intro}>
              ...
              <div>
                ...
                <div className={styles.nickname}>
                  <AiOutlineUser /> {productDetail.nickname}
                </div>
              </div>
            </div>
          )}
        ...
        <div className={styles.right}>
          ...
          <div className={styles.btn} onClick={handlePurchase}>
            결제하기
          </div>
        </div>
      </div>
