    ...
    <div>
      ...
      <div className={styles.MainState}>
        ...
        <div className={styles.MainState_record}>
          ...
          <div className={`${styles.subtitle} ${recordState !== 0 && styles.disabled}`}>학습은 최대 1시간 정도 소요됩니다.</div>
        ...
        <div className={styles.MainState_record}>
          ...
          <div className={`${styles.subtitle} ${recordState !== 0 && styles.disabled}`}>학습 후 등록 및 설정을 해주세요</div>
